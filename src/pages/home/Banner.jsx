...
const Banner = () => {
    return (
        ...
        <div className="carousel rounded-2xl h-[500px]">
          <div id="slide1" className="carousel-item relative w-full">
            ...
            <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center text-white">
              <h2 className="md:text-4xl text-2xl text-center font-bold md:mb-3">Discover Masterpieces</h2>
              <p className='text-center '>Explore breathtaking artworks from talented creators.</p>
            </div>
